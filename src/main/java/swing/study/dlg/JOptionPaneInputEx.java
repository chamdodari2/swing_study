...
public class JOptionPaneInputEx extends JFrame implements ActionListener {
	...
	private void initialize() {
		setTitle("Input Dlg 예제");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 1041, 300);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		contentPane.setLayout(new GridLayout(0, 3, 0, 0));

		JLabel lbl1 = new JLabel("JOptionPane.showInputDialog(Opject message);");
		...
		JLabel lbl2 = new JLabel("JOptionPane.showInputDialog(message, initialSelectionValue)");
		...
		lbl3 = new JLabel("JOptionPane.showInputDialog(parentComponent,   Object message,String title, int messageType)");
		...
		lbl4 = new JLabel("JOptionPane.showInputDialog(Opject message);");
...
*/
		...
		ImageIcon icon = new ImageIcon(imgPath + "집.png");
